...
class SymbolicResult(object):
    def __init__(self, xid,history_states, state, constraints, sha_constraints, target_op):
        self.xid = xid
    ...
    def copy(self):
        ...
        new_history_states = [_state.copy(new_xid) for _state in self.history_states]

        return SymbolicResult(new_xid, new_history_states, new_state, new_constraints, new_sha_constraints, self.target_op)
